...
export default function Footer() {
  return (
    <footer className="relative w-full max-w-[1728px] mx-auto py-8 md:h-[138px] bg-white">
      ...
      <div className="md:hidden flex flex-col items-center space-y-6 px-4">
        {/* Social Icons */}
        ...
        <div className="grid grid-cols-2 gap-x-8 gap-y-3 text-center">
          <Link href="/about" className="font-poppins text-[15px] font-medium leading-[20px] text-[#6B6B6B] hover:text-[#1B1464]">About Us</Link>
          <Link href="/privacy" className="font-poppins text-[15px] font-medium leading-[20px] text-[#6B6B6B] hover:text-[#1B1464]">Privacy Policy</Link>
          <Link href="/terms" className="font-poppins text-[15px] font-medium leading-[20px] text-[#6B6B6B] hover:text-[#1B1464]">Terms and Conditions</Link>
          <Link href="/pricing" className="font-poppins text-[15px] font-medium leading-[20px] text-[#6B6B6B] hover:text-[#1B1464]">Pricing</Link>
        </div>

        {/* Copyright */}
        <div className="flex flex-col items-center text-center">
          <span className="font-inter text-[14px] leading-[20px] text-[#6B6B6B]">© StudioSix, 2025</span>
          <span className="font-inter text-[14px] leading-[20px] text-[#6B6B6B]">Visionate (PTY) Ltd. All Rights Reserved</span>
        </div>
      </div>
    </footer>
  );
